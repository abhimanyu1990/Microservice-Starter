...
public class SwaggerConfiguration {
    ...
    public Docket newApi() {
        return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("poc.projectmgt.user.controllers")).paths(PathSelectors.regex("/*.*")).build().securitySchemes(Lists.newArrayList(apiKey()))
